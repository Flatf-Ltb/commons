 ...
 */
package io.flatf.common.collections.art;
...
public final class LongAdaptiveRadixTreeMap<V> {
    ...
    public void remove(final long key) {
        if (root != null) {
            final ArtNode<V> downSizeNode = root.remove(key, INITIAL_LEVEL);
    ...
    static <V> ArtNode<V> branchIfRequired(final long key, final V value, final long nodeKey, final int nodeLevel,
                                           final ArtNode<V> caller) {
